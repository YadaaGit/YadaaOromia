...
className={bg-white rounded-xl shadow-sm border border-gray-100 p-5 text-center transition hover:shadow-md ${   isClickable ? "cursor-pointer hover:ring-2 ring-yellow-400" : ""   }}
>
